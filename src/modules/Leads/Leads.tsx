    ...
    <Box style={{
      ...
      >
        ...
        >
          ...
          >
            Showing <span style={{ fontWeight: "bold" }}>10</span> lead(s) out
            of <span style={{ fontWeight: "bold" }}>100</span>
          </Text>
        </Flex>
      </Flex>
          ...
          {leadsData.map((lead, index) => (
            <Flex
              ...
              style={{
                marginTop: "10px",
                borderBottom:
                  index < leadsData.length - 1 ? "1px solid #e5e7eb" : "none",
                paddingBottom: "10px",
              }}
            >
              <Box
              ...
              >
                ...
                >
                  ...
                  >
                    <option
                      value="Contacted"
                      selected={lead.contacted === "Contacted"}
                    >
                      Contacted
                    </option>
                    <option
                      value="Not Contacted"
                      selected={lead.contacted === "Not Contacted"}
                    >
                      Not Contacted
                    </option>
                  </select>
                ...
                >
                  ...
                  >
                    ...
                    <option
                      value="Shivam"
                      selected={lead.assignedTo === "Shivam"}
                    >
                      Shivam
                    </option>
      ...
      >
        ...
        <Text style={{ fontSize: "14px", color: "#6b7280" }}>
          Page{" "}
          <span style={{ fontWeight: "bold", color: "#000" }}>{currentPage}</span> of{" "}
